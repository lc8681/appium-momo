...
android_caps.wd.find_element_by_id("toolbar_search_edittext").send_keys("34805293")
try:
    android_caps.wd.find_element_by_android_uiautomator('new UiSelector().text("群组号:34805293")').click()
except:
    print("没有搜素到群组")
...
sleep(3)
android_caps.wd.find_element_by_id("message_iv_playimage").click()
try:
